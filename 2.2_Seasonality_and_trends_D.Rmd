...
* A cold snap that caused coral mortality in March 2010
* Extreme precipitation that reduced salinity in October 2011 ()
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
scaleFactor_T <- 
  (max(FLK.data$BestSalinity)-min(FLK.data$BestSalinity))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

scaleFactor_T2 <- ((mean(FLK.data$BestSalinity)-
                     mean(FLK.data$Temperature_C))/scaleFactor_T)

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T)+ 10 
  summary(FLK.data$Temp.adj)
...
scaleFactor_T <- 
  (max(FLK.data$TA_umol_kg, na.rm = T)-
     min(FLK.data$TA_umol_kg, na.rm = T))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

scaleFactor_T2 <- (mean(FLK.data$TA_umol_kg,na.rm = T)-
                     mean(FLK.data$Temperature_C))

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T)+ 1300
  summary(FLK.data$Temp.adj)
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
scaleFactor_T <- 
  (max(FLK.data$DIC_umol_kg, na.rm = T)-
     min(FLK.data$DIC_umol_kg, na.rm = T))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

scaleFactor_T2 <- (mean(FLK.data$DIC_umol_kg,na.rm = T)-
                     mean(FLK.data$Temperature_C))

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T)+ 1000
  summary(FLK.data$Temp.adj)
...
DIC_month<- Month_ploth+
    ...
    geom_smooth(data=FLK.data, se=F, colour="gray70", 
                alpha=0.5, size=0.5,
                aes(x=as.numeric(Month2), y=Temp.adj))+
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
scaleFactor_T <- 
  (max(FLK.data$pCO2_uatm, na.rm = T)-
   min(FLK.data$pCO2_uatm, na.rm = T))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

scaleFactor_T2 <- (mean(FLK.data$pCO2_uatm,na.rm = T)-
                     mean(FLK.data$Temperature_C))

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T) - scaleFactor_T2
  summary(FLK.data$Temp.adj)
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
scaleFactor_T <- 
  (max(FLK.data$pH_calculated, na.rm = T)-
     min(FLK.data$pH_calculated, na.rm = T))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T) + 7.3
  summary(FLK.data$Temp.adj)
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
scaleFactor_T <- 
  (max(FLK.data$Aragonite_Sat_W, na.rm = T)-
     min(FLK.data$Aragonite_Sat_W, na.rm = T))/
  (max(FLK.data$Temperature_C)-min(FLK.data$Temperature_C))

FLK.data$Temp.adj<-(FLK.data$Temperature * scaleFactor_T) -0.9
  summary(FLK.data$Temp.adj)
